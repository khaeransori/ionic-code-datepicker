(function() {
    ...
    angular
        .module('code-datepicker.service', ['ionic'])
        .factory('codeDatepickerService', codeDatepickerService);

    codeDatepickerService.$inject = [];

    /* @ngInject */
    function codeDatepickerService() {
        ...
        var service = {
            ...
            getYears: _getYears,
            getActiveYearSlide: _getActiveYearSlide,
            getMonths: _getMonths,
            getDaysOfTheWeek: _getDaysOfTheWeek,
            getPreviousMonth: _getPreviousMonth,
            sameDate: _sameDate,
            createMonth: _createMonth,
